...
+ (UIColor *) randomColor{
    ...
    switch (i) {
        case 0:
            color = [[self class] turquoiseColor];
            break;
        case 1:
            color = [[self class] greenSeaColor];
            break;
        case 2:
            color = [[self class] emerlandColor];
            break;
        case 3:
            color = [[self class] nephritisColor];
            break;
        case 4:
            color = [[self class] peterRiverColor];
            break;
        case 5:
            color = [[self class] belizeHoleColor];
            break;
        case 6:
            color = [[self class] amethystColor];
            break;
        case 7:
            color = [[self class] wisteriaColor];
            break;
        case 8:
            color = [[self class] wetAsphaltColor];
            break;
        case 9:
            color = [[self class] midnightBlueColor];
            break;
        case 10:
            color = [[self class] sunflowerColor];
            break;
        case 11:
            color = [[self class] carrotColor];
            break;
        case 12:
            color = [[self class] pumpkinColor];
            break;
        case 13:
            color = [[self class] alizarinColor];
            break;
        case 14:
            color = [[self class] pomegranateColor];
            break;
        case 15:
            color = [[self class] silverColor];
            break;
        case 16:
            color = [[self class] concreteColor];
            break;
        case 17:
            color = [[self class] asbestosColor];
            break;
        case 18:
            color = HDRED;
            break;
